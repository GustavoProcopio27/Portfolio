...
export default function Hero()
{
    return(
        <section id="hero" className="mt-12 grid grid-cols-2 p-2 ">
            <div className="p-4 rounded-3xl flex justify-center flex-col bg-bg-primary gap-8 shadow-2xl ml-8">
                <p className="font-bold text-3xl text-center">Oi, sou Gustavo Procópio</p>
                ...
                <span className="text-justify p-8 text-xl">
                    ...
                    <p className="mt-2 text-xl font-semibold">Busco posição como desenvolvedor júnior/estagiário para aplicar e ampliar minhas competências</p>
                </span>
                ...
                <div className="flex justify-center">
                    <div className="flex flex-row j bg-teal-950 text-ghostwhite w-fit p-2 rounded-2xl gap-2">
